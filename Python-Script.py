...
if str(platform.system()) == 'Linux':
    os.system('figlet Cyberspace Association DDoS Attack')
else:
    os.system('pyfiglet Cyberspace Association  DDoS Attack')

print(Back.GREEN + Fore.GREEN +'[+] Cyberspace Association tool by' + Fore.RED + 'Cyberspace Association Viet Nam Community                              ') 
print(Back.GREEN + Fore.BLACK + '[+] Cyberspace Association Tool BETA VERSION 0.1                                             ')
print(Back.BLACK +Fore.GREEN + '[+] Cyberspace Association Tool Interactive Menu in Python by Cyberspace Association                         ')
print(Fore.YELLOW + '[+] We are Cyberspace Association, We are a Legion, We do not Forgive, We do not Forget                            ')
print(Fore.GREEN + '[+] Starting Cyberspace Association DoS Tool with 1024 Baseline Threads as Default change below as Required           ')
print(Fore.BLUE + 'FB: ' + Fore.GREEN + 'Nhật Minh Dương')
print(Fore.RED + 'Zalo: ' + Fore.GREEN + 'https://zalo.me/g/ziowas384')
print(Fore.YELLOW + 'Address: ' + Fore.GREEN + 'Texas, New York')
